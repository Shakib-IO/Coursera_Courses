...
def answer_three():
    df_result = df.copy()
    df_result = df_result[(df_result['Gold.1'] > 0) & (df_result['Gold'] > 0)]
    df_result['Gold Medal Diff'] = abs(df_result['Gold'] - df_result['Gold.1'])
    df_result['Total Gold'] = df_result['Gold'] + df_result['Gold.1'] + df_result['Gold.2']
    df_result['Relative Gold'] = df_result['Gold Medal Diff']/df_result['Total Gold']
    return df_result['Relative Gold'].argmax()
answer_three()
